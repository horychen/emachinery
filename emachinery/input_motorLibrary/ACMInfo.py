...
if __name__ == '__main__':
    ...
    with open('motor_library.json', 'w', encoding='utf-8') as f:
...
class MotorJson(object):
    ...
    def __init__(self):
        ...
        # self.fname = os.path.dirname(__file__)+'/machine_specification-auto.json'
        self.fname = pkg_resources.resource_filename(__name__, './machine_specification-auto.json')
        print('\t[ACMInfo.py] Loading:', self.fname)
