...
#define DATA_LABELS "ACM.Tem,marino.torque_cmd,marino.torque__fb,ACM.TLoad,marino.xTL,CTRL.deriv_omg_cmd,ACM.rpm_cmd,ACM.rpm,marino.xOmg*RAD_PER_SEC_2_RPM,CTRL.psi_cmd,marino.psi_Dmu,marino.e_psi_Dmu,marino.e_psi_Qmu,CTRL.iDs_cmd,ACM.iMs,CTRL.iDs,CTRL.iQs_cmd,ACM.iTs,CTRL.iQs,CTRL.uDs_cmd,CTRL.uQs_cmd,ACM.theta_M,marino.xRho,holtz.psi_D2,holtz.psi_D2_ode1,holtz.psi_Q2,holtz.psi_Q2_ode1\n"
